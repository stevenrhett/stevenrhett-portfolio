    ...
    <form>
      <div className=" max-w-2xl px-6 lg:px-8">
        <div className="max-w-2xl">
          <h2 className="text-md font-semibold leading-7 text-gray-900">Personal Information</h2>
          <p className="mt-1 text-md leading-6 text-gray-600">Use a permanent address where you can receive mail.</p>
          <div className="grid max-w-2xl grid-cols-2 gap-x-6 gap-y-2 col-span-2">
          ...
          <div className="col-span-3">
            ...
            <div className="mt-2">
              <select
                ...
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:max-w-xs sm:text-md sm:leading-6"
              >
        ...
        <div className="p-4 flex items-center justify-start gap-x-6">
        <button type="button" className="text-md fontSemibold leading-6 text-gray-900">
          Cancel
        </button>
        <button
          type="submit"
