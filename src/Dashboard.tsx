  ...
  return (
    <>
      <div className="flex h-full">
        {/* Narrow sidebar */}
        <div className="hidden w-28 overflow-y-auto bg-purple-200 md:block">
                ...
                <a
                  ...
                  className={classNames(
                    item.current
                      ...
                      : "text-purple-900 hover:bg-purple-400 hover:text-white",
                ...
                >
                  <item.icon
                    className={classNames(
                      item.current
                        ? "text-white"
                        : "text-purple-900 group-hover:text-white",
                      "h-6 w-6"
                    )}
                    aria-hidden="true"
                  />
        ...
        <Transition.Root show={mobileMenuOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-purple-200 pt-5 pb-4">
                  <Transition.Child
                    as={Fragment}
                          ...
                          <a
                            ...
                            className={classNames(
                              item.current
                                ...
                                : "text-purple-900 hover:bg-purple-400 hover:text-purple-900",
                  ...
                  >
                    ...
                    <div className="relative w-full text-purple-900 focus-within:text-purple-900">
                      ...
                      <input
                        name="search-field"
                        id="search-field"
                        className="h-full w-full border-transparent py-2 pl-8 pr-3 text-purple-900 placeholder-purple-500 focus:border-transparent focus:placeholder-purple-400 focus:outline-none focus:ring-0"
                        placeholder="Search"
                        type="search"
                      />
                    </div>
                            ...
                            {({ active }) => (
                              <a
                                ...
                                className={classNames(
                                  ...
                                  "block px-4 py-2 text-sm text-purple-900"
                                )}
                              >
                                {item.name}
                              </a>
